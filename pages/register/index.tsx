    ...
    <MainLayout title='Register'>
      <div className='h-full flex items-center justify-center'>
        <div className='bg-slate-200 p-[30px] flex flex-col gap-8  rounded-lg shadow-md m-20'>
          <h1 className='text-center text-[30px] text-gray-800 font-semibold font-lato'>Registro</h1>
          <Formik
              ...
              (({ isSubmitting }) => (
                <Form>
                  <div className='grid grid-cols-[300px_300px] gap-5'>
                    <Input label='Nombres' name='names' type='text' maxLength={50} autoComplete='off' />
                    <Input label='Primer Apellido' name='first_lastname' type='text' maxLength={50} autoComplete='off' />
                  </div>
                  <div className='grid grid-cols-[300px_300px] gap-5'>
                    <Input label='Segundo Apellido' name='second_lastname' type='text' maxLength={50} autoComplete='off' />
                    <Input label='Dni' name='dni' type='text' maxLength={8} autoComplete='off' />
                  </div>
                  <div className='grid grid-cols-[300px_300px] gap-5'>
                    <Input label='Telefono' name='phone_number' type='text' maxLength={9} autoComplete='off' />

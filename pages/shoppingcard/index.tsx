  ...
  const handlecreateOrder = async () => {
    try {
      ...
      const res = await axios({
        url: `${process.env.NEXT_PUBLIC_URL}api/payment`,
        method: "POST",
        headers: {
                ...
                <div className="flex flex-row justify-between items-center">
                  ...
                  <div className="w-full md:w-1/5 mx-2 flex justify-center items-center">
                    <div className="bg-custom-color-beige shadow-md rounded-md p-6 w-full md:w-96">
                      ...
                      <button
                        className={`${
                          cartItems.length === 0 || areAllItemsDisabled()
                            ? "bg-black opacity-30"
                            : "bg-black"
                        } ${
                          isPay ? "hidden" : ""
                      ...
                      {isPay ? (
                        <div>
                          <ButtonPaypal
                            ...
                            areAllItemsDisabled={areAllItemsDisabled}
                            cartItems={cartItems}
                            handleOnAprove={handleOnAprove}

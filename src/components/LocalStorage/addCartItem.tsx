import { IGetProduct } from "@/src/models/product.interface";

const handleAddToCart = (user: string, product: IGetProduct | null, quantity: number) => {
    ...
    const existingProductIndex = cart.findIndex(
      (item: any) => item.product.id_product+"" === product?.data.id_product+""
    );
